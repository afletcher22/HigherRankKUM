...
lrat_refutation_chunked cert (include_str "../data/baseG3.cnf") (include_str "../data/baseG3.lrat") 150000

f_witnesses ws (include_str "../data/baseG3.wit")

theorem ws_valid : ws.all (validF 10 densTab10 (factsOfRanks (ranksG 3))) = true := by decide +kernel
