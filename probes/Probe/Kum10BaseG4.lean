...
f_certificate cert (include_str "../data/baseG4.cnf") (include_str "../data/baseG4.lrat")
  (include_str "../data/baseG4.wit") (validF 10 densTab10 (factsOfRanks (ranksG 4))) (genF 10) 100000 3000
