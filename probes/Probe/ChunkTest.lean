...
/-!
Control for `lrat_refutation_chunked`: the cyclic extension certificate for `N = 8` (12 positions): no rank model of a rank-4 matroid
with a basis `S` and an 8-element cyclic ordering of the rest (all 4-windows bases) avoids a
successful interleaving.
-/

namespace Probe.Enc.ChunkTest

set_option maxHeartbeats 0
set_option maxRecDepth 100000
set_option profiler true

lrat_refutation_chunked cert (include_str "../data/xcyc8.cnf") (include_str "../data/xcyc8.lrat") 60000
