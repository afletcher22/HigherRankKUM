...
theorem theorem_2_1 : Statement α := by
  classical
...
theorem solvesKUMAtRankSize_of_coprime {r m : ℕ} (hcop : Nat.Coprime r m) :
    SolvesKUMAtRankSize α r m :=
  coprime_kum theorem_2_1 hcop

#print axioms theorem_2_1
#print axioms solvesKUMAtRankSize_of_coprime
