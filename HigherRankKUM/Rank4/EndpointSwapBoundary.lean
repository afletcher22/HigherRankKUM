...
/-- Under swap03, the boundary window beginning one position after the moved
start replaces the old offset-3 element by the old offset-0 element. -/
theorem swap03_window_plus_one_eq
    {E : Set α} {n : ℕ}
    (hn : 0 < n) (h7n : 7 ≤ n)
    (σ : Fin n ≃ E) (s : Fin n) :
    cyclicWindow 4 hn
      ...
      ({(σ (cyclicIndex n hn s 1) : α),
        (σ (cyclicIndex n hn s 2) : α),
        (σ s : α),
        (σ (cyclicIndex n hn s 4) : α)} : Set α) := by
  have h4 :=
  ...
  norm_num
  rw [apply_swap03_one, apply_swap03_two, apply_swap03_three, h4]

theorem original_window_plus_one_eq
    {E : Set α} {n : ℕ}
    (hn : 0 < n)
    (σ : Fin n ≃ E) (s : Fin n) :
    cyclicWindow 4 hn σ (cyclicIndex n hn s 1) =
      ({(σ (cyclicIndex n hn s 1) : α),
        (σ (cyclicIndex n hn s 2) : α),
...
theorem swap03_plus_one_dep_forces_closure
  ...
  have ha1 :
    ...
    simpa [cyclicIndex_zero] using
      (cyclicOrder_value_ne_of_offsets_ne
        hn σ s (a := 0) (b := 1) (by omega) (by omega) (by omega))
  have ha2 :
      (σ s : α) ≠ (σ (cyclicIndex n hn s 2) : α) := by
    simpa [cyclicIndex_zero] using
      (cyclicOrder_value_ne_of_offsets_ne
        hn σ s (a := 0) (b := 2) (by omega) (by omega) (by omega))
  have ha4 :
...
/-- Under swap03, the boundary window beginning two positions after the moved
start replaces the old offset-3 element by the old offset-0 element. -/
theorem swap03_window_plus_two_eq
    {E : Set α} {n : ℕ}
    (hn : 0 < n) (h7n : 7 ≤ n)
    (σ : Fin n ≃ E) (s : Fin n) :
    cyclicWindow 4 hn
      ...
      ({(σ (cyclicIndex n hn s 2) : α),
        (σ s : α),
        (σ (cyclicIndex n hn s 4) : α),
        (σ (cyclicIndex n hn s 5) : α)} : Set α) := by
  have h4 :=
    applyFourBlockPerm_eq_at_offset_of_four_le
      hn (by omega) σ s swap03 (t := 4) (by omega) (by omega)
  have h5 :=
  ...
  simp only [cyclicIndex_add]
  norm_num
  rw [apply_swap03_two, apply_swap03_three, h4, h5]

theorem original_window_plus_two_eq
    {E : Set α} {n : ℕ}
    (hn : 0 < n)
    (σ : Fin n ≃ E) (s : Fin n) :
    cyclicWindow 4 hn σ (cyclicIndex n hn s 2) =
      ({(σ (cyclicIndex n hn s 2) : α),
        (σ (cyclicIndex n hn s 3) : α),
        (σ (cyclicIndex n hn s 4) : α),
        (σ (cyclicIndex n hn s 5) : α)} : Set α) := by
...
theorem swap03_plus_two_dep_forces_closure
    {M : Matroid α} {E : Set α} {n : ℕ}
    (hn : 0 < n) (h7n : 7 ≤ n)
    (σ : Fin n ≃ E) (s : Fin n)
    (hCBO : CyclicBasisOrder M 4 hn σ)
